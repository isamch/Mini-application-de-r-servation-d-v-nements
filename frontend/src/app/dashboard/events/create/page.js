...
import { ArrowLeft, Calendar, Clock, MapPin, Users, FileText, Save, Plus } from 'lucide-react';
...
export default function CreateEventPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push(`/dashboard/events/${response.data.data.id}`);
    } catch (error) {
      ...
      <div className="relative z-10 p-6 md:p-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-700">Build amazing experiences for your community</p>
          </div>
